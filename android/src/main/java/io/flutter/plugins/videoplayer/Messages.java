...
public class Messages {
  ...
  public static class CreateMessage {
    ...
    private @Nullable String adUri;
    public @Nullable String getAdUri() { return adUri; }
    public void setAdUri(@Nullable String setterArg) {
      this.adUri = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable String adUri;
      public @NonNull Builder setAdUri(@Nullable String setterArg) {
        this.adUri = setterArg;
        return this;
      }
      private @Nullable String packageName;
    ...
    static @NonNull CreateMessage fromMap(@NonNull Map<String, Object> map) {
      ...
      Object adUri = map.get("adUri");
      pigeonResult.setAdUri((String)adUri);
